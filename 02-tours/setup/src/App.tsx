  ...
  const [list, setList] = useState<Card[]>([
    {
      ...
      imageUrl: "https://dl.airtable.com/.attachments/a0cd0702c443f31526267f38ea5314a1/2447eb7a/paris.jpg",
    },
    {
      ...
      imageUrl: "https://dl.airtable.com/.attachments/6c24084000a3777064c5200a8c2ae931/04081a3e/ireland.jpeg"
    },
    {
      ...
      imageUrl: "https://dl.airtable.com/.attachments/27f6cbfe631e303f98b97e9dafacf25b/6bbe2a07/vienna.jpeg"
    },
    {
      ...
      imageUrl: "https://dl.airtable.com/.attachments/3efa7aa402d49c12b8769c581a96af42/d5b641e3/italy.jpeg"
    },
    {
      ...
      imageUrl: "https://dl.airtable.com/.attachments/3feee7a93af0f4f809312132090c9a80/58e3e8ec/poland.jpeg"
    }
  ]);

  function removeItem(idx : number) {
    setList(list.filter((li, i) => {
      return i !== idx;
    }));
  }
